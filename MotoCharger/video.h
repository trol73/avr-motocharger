...
/************************************************************************/
/* Видеопамять - две страницы по 2x16 символов                          */
/************************************************************************/
char video_memory[2*16*2];

/************************************************************************/
/* Если true, то мигающие области показываются, иначе - скрываются      */
/************************************************************************/
bool video_blinkingState;


/************************************************************************/
/* Режим мерцания. Если включен, то в фазе video_blinkingState=false    */
/* функции video_WriteXXX() будут выводить на экран пустоту             */ 
/************************************************************************/
bool video_blinkingEnable;
...
void video_Write(char ch) {
	if (!video_blinkingEnable || video_blinkingState) {
...
/************************************************************************/
/* Включает режим мерцания. Если мерцание включено, то в фазе           */
/* video_blinkingState = false все методы вывода video_WriteXXX()       */
/* будут выводить на экран пустоту                                      */
/************************************************************************/
inline void video_SetBlinking(bool enable) {
	video_blinkingEnable = enable;
}
